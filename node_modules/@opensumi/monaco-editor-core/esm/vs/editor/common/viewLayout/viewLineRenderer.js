...
function _renderLine(input, sb) {
    ...
    if (isOverflowing) {
        ...
        sb.appendString(nls.localize("vs/editor/common/viewLayout/viewLineRenderer",0, "Show more ({0})", renderOverflowingCharCount(overflowingCharCount)));
        sb.appendString('</span>');
    }
    sb.appendString('</span>');
...
function renderOverflowingCharCount(n) {
    if (n < 1024) {
        return nls.localize("vs/editor/common/viewLayout/viewLineRenderer",1, "{0} chars", n);
    }
    if (n < 1024 * 1024) {
