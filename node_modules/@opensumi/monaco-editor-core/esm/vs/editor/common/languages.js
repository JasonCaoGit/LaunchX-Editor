...
export const symbolKindNames = {
    [17 /* SymbolKind.Array */]: localize("vs/editor/common/languages",0, "array"),
    [16 /* SymbolKind.Boolean */]: localize("vs/editor/common/languages",1, "boolean"),
    [4 /* SymbolKind.Class */]: localize("vs/editor/common/languages",2, "class"),
    [13 /* SymbolKind.Constant */]: localize("vs/editor/common/languages",3, "constant"),
    [8 /* SymbolKind.Constructor */]: localize("vs/editor/common/languages",4, "constructor"),
    [9 /* SymbolKind.Enum */]: localize("vs/editor/common/languages",5, "enumeration"),
    [21 /* SymbolKind.EnumMember */]: localize("vs/editor/common/languages",6, "enumeration member"),
    [23 /* SymbolKind.Event */]: localize("vs/editor/common/languages",7, "event"),
    [7 /* SymbolKind.Field */]: localize("vs/editor/common/languages",8, "field"),
    [0 /* SymbolKind.File */]: localize("vs/editor/common/languages",9, "file"),
    [11 /* SymbolKind.Function */]: localize("vs/editor/common/languages",10, "function"),
    [10 /* SymbolKind.Interface */]: localize("vs/editor/common/languages",11, "interface"),
    [19 /* SymbolKind.Key */]: localize("vs/editor/common/languages",12, "key"),
    [5 /* SymbolKind.Method */]: localize("vs/editor/common/languages",13, "method"),
    [1 /* SymbolKind.Module */]: localize("vs/editor/common/languages",14, "module"),
    [2 /* SymbolKind.Namespace */]: localize("vs/editor/common/languages",15, "namespace"),
    [20 /* SymbolKind.Null */]: localize("vs/editor/common/languages",16, "null"),
    [15 /* SymbolKind.Number */]: localize("vs/editor/common/languages",17, "number"),
    [18 /* SymbolKind.Object */]: localize("vs/editor/common/languages",18, "object"),
    [24 /* SymbolKind.Operator */]: localize("vs/editor/common/languages",19, "operator"),
    [3 /* SymbolKind.Package */]: localize("vs/editor/common/languages",20, "package"),
    [6 /* SymbolKind.Property */]: localize("vs/editor/common/languages",21, "property"),
    [14 /* SymbolKind.String */]: localize("vs/editor/common/languages",22, "string"),
    [22 /* SymbolKind.Struct */]: localize("vs/editor/common/languages",23, "struct"),
    [25 /* SymbolKind.TypeParameter */]: localize("vs/editor/common/languages",24, "type parameter"),
    [12 /* SymbolKind.Variable */]: localize("vs/editor/common/languages",25, "variable"),
};
/**
 * @internal
 */
export function getAriaLabelForSymbol(symbolName, kind) {
    return localize("vs/editor/common/languages",26, '{0} ({1})', symbolName, symbolKindNames[kind]);
}
