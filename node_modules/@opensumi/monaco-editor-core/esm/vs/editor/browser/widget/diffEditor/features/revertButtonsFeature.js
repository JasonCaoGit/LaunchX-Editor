    ...
    constructor(_lineNumber, _widget, _diffs, _revertSelection) {
        ...
        this._domNode = h('div.revertButton', {
            title: this._revertSelection
                ? localize("vs/editor/browser/widget/diffEditor/features/revertButtonsFeature",0, 'Revert Selected Changes')
                : localize("vs/editor/browser/widget/diffEditor/features/revertButtonsFeature",1, 'Revert Change')
