...
let DiffEditorEditors = class DiffEditorEditors extends Disposable {
    ...
    _updateAriaLabel(ariaLabel) {
        ...
        const ariaNavigationTip = localize("vs/editor/browser/widget/diffEditor/components/diffEditorEditors",0, ' use {0} to open the accessibility help.', this._keybindingService.lookupKeybinding('editor.action.accessibilityHelp')?.getAriaLabel());
