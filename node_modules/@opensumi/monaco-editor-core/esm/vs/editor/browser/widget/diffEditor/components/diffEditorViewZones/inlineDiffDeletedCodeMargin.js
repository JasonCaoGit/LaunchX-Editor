                ...
                getActions: () => {
                    ...
                    actions.push(new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ? (_diff.original.length > 1
                            ? localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",0, "Copy deleted lines")
                            : localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",1, "Copy deleted line"))
                        : (_diff.original.length > 1
                            ? localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",2, "Copy changed lines")
                            : localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",3, "Copy changed line")), undefined, true, async () => {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(new Action('diff.clipboard.copyDeletedLineContent', isDeletion
                            ? localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",4, "Copy deleted line ({0})", _diff.original.startLineNumber + currentLineNumberOffset)
                            : localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",5, "Copy changed line ({0})", _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(new Action('diff.inline.revertChange', localize("vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin",6, "Revert this change"), undefined, true, async () => {
