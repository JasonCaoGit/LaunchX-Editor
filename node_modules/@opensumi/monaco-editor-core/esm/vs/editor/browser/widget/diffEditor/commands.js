...
export class ToggleCollapseUnchangedRegions extends Action2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",0, 'Toggle Collapse Unchanged Regions'),
            icon: Codicon.map,
...
export class ToggleShowMovedCodeBlocks extends Action2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",1, 'Toggle Show Moved Code Blocks'),
            precondition: ContextKeyExpr.has('isInDiffEditor'),
        });
    }
    run(accessor, ...args) {
...
export class ToggleUseInlineViewWhenSpaceIsLimited extends Action2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",2, 'Toggle Use Inline View When Space Is Limited'),
            precondition: ContextKeyExpr.has('isInDiffEditor'),
        });
    }
    run(accessor, ...args) {
...
const diffEditorCategory = localize2("vs/editor/browser/widget/diffEditor/commands",3, "Diff Editor");
export class SwitchSide extends EditorAction2 {
    constructor() {
        super({
            id: 'diffEditor.switchSide',
            title: localize2("vs/editor/browser/widget/diffEditor/commands",4, 'Switch Side'),
...
export class ExitCompareMove extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",5, 'Exit Compare Move'),
            icon: Codicon.close,
...
export class CollapseAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",6, 'Collapse All Unchanged Regions'),
            icon: Codicon.fold,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            f1: true,
            category: diffEditorCategory,
...
export class ShowAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",7, 'Show All Unchanged Regions'),
            icon: Codicon.unfold,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            f1: true,
            category: diffEditorCategory,
...
export class RevertHunkOrSelection extends Action2 {
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",8, 'Revert'),
            f1: false,
            category: diffEditorCategory,
        });
    }
...
const accessibleDiffViewerCategory = localize2("vs/editor/browser/widget/diffEditor/commands",9, "Accessible Diff Viewer");
export class AccessibleDiffViewerNext extends Action2 {
    static { this.id = 'editor.action.accessibleDiffViewer.next'; }
    constructor() {
        super({
            id: AccessibleDiffViewerNext.id,
            title: localize2("vs/editor/browser/widget/diffEditor/commands",10, 'Go to Next Difference'),
...
export class AccessibleDiffViewerPrev extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2("vs/editor/browser/widget/diffEditor/commands",11, 'Go to Previous Difference'),
            category: accessibleDiffViewerCategory,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            keybinding: {
