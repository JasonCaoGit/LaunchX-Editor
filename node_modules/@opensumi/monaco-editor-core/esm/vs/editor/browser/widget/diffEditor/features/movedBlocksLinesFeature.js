...
class MovedBlockOverlayWidget extends ViewZoneOverlayWidget {
    constructor(_editor, _viewZone, _move, _kind, _diffModel) {
        ...
        if (_move.changes.length > 0) {
            text = this._kind === 'original' ? localize("vs/editor/browser/widget/diffEditor/features/movedBlocksLinesFeature",0, 'Code moved with changes to line {0}-{1}', this._move.lineRangeMapping.modified.startLineNumber, this._move.lineRangeMapping.modified.endLineNumberExclusive - 1) : localize("vs/editor/browser/widget/diffEditor/features/movedBlocksLinesFeature",1, 'Code moved with changes from line {0}-{1}', this._move.lineRangeMapping.original.startLineNumber, this._move.lineRangeMapping.original.endLineNumberExclusive - 1);
        }
        else {
            text = this._kind === 'original' ? localize("vs/editor/browser/widget/diffEditor/features/movedBlocksLinesFeature",2, 'Code moved to line {0}-{1}', this._move.lineRangeMapping.modified.startLineNumber, this._move.lineRangeMapping.modified.endLineNumberExclusive - 1) : localize("vs/editor/browser/widget/diffEditor/features/movedBlocksLinesFeature",3, 'Code moved from line {0}-{1}', this._move.lineRangeMapping.original.startLineNumber, this._move.lineRangeMapping.original.endLineNumberExclusive - 1);
        }
