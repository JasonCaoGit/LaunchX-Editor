...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        ...
        title: localize("vs/editor/browser/widget/diffEditor/diffEditor.contribution",0, "Use Inline View When Space Is Limited"),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        ...
        title: localize("vs/editor/browser/widget/diffEditor/diffEditor.contribution",1, "Show Moved Code Blocks"),
        icon: Codicon.move,
...
for (const ctx of [
    ...
    MenuRegistry.appendMenuItem(MenuId.DiffEditorHunkToolbar, {
        command: {
            ...
            title: localize("vs/editor/browser/widget/diffEditor/diffEditor.contribution",2, "Revert Block"),
            icon: ctx.icon,
        },
    ...
    MenuRegistry.appendMenuItem(MenuId.DiffEditorSelectionToolbar, {
        command: {
            id: new RevertHunkOrSelection().desc.id,
            title: localize("vs/editor/browser/widget/diffEditor/diffEditor.contribution",3, "Revert Selection"),
            icon: ctx.icon,
        },
        when: ContextKeyExpr.and(EditorContextKeys.diffEditorModifiedWritable, ctx.key),
        order: 5,
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        ...
        title: localize("vs/editor/browser/widget/diffEditor/diffEditor.contribution",4, "Open Accessible Diff Viewer"),
        precondition: ContextKeyExpr.has('isInDiffEditor'),
    },
    order: 10,
    group: '2_diff',
