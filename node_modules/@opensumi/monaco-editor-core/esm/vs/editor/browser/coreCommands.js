...
(function (CoreNavigationCommands) {
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            'sticky': {
                                description: nls.localize("vs/editor/browser/coreCommands",0, "Stick to the end even when going to longer lines"),
                                type: 'boolean',
                                default: false
                            }
                        }
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            'sticky': {
                                description: nls.localize("vs/editor/browser/coreCommands",1, "Stick to the end even when going to longer lines"),
                                type: 'boolean',
                                default: false
                            }
                        }
    ...
    CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(new class extends CoreEditorCommand {
        ...
        runCoreEditorCommand(viewModel, args) {
            ...
            viewModel.revealAllCursors(args.source, true);
            status(nls.localize("vs/editor/browser/coreCommands",2, "Removed secondary cursors"));
        }
    });
