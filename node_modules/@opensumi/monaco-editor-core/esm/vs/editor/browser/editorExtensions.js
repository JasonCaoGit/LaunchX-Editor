...
export const UndoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_do',
            title: nls.localize("vs/editor/browser/editorExtensions",0, "&&Undo"),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize("vs/editor/browser/editorExtensions",1, "Undo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize("vs/editor/browser/editorExtensions",2, "Undo"),
            order: 1
        }]
}));
...
export const RedoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.MenubarEditMenu,
            group: '1_do',
            title: nls.localize("vs/editor/browser/editorExtensions",3, "&&Redo"),
            order: 2
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize("vs/editor/browser/editorExtensions",4, "Redo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize("vs/editor/browser/editorExtensions",5, "Redo"),
            order: 2
        }]
}));
...
export const SelectAllCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: nls.localize("vs/editor/browser/editorExtensions",6, "&&Select All"),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize("vs/editor/browser/editorExtensions",7, "Select All"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '9_select',
            title: nls.localize("vs/editor/browser/editorExtensions",8, "Select All"),
            order: 1
        }]
}));
