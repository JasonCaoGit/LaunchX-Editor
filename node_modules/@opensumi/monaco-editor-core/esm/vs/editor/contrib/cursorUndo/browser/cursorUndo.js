...
export class CursorUndo extends EditorAction {
    constructor() {
        super({
            id: 'cursorUndo',
            label: nls.localize2("vs/editor/contrib/cursorUndo/browser/cursorUndo",0, "Cursor Undo"),
...
export class CursorRedo extends EditorAction {
    constructor() {
        super({
            id: 'cursorRedo',
            label: nls.localize2("vs/editor/contrib/cursorUndo/browser/cursorUndo",1, "Cursor Redo"),
            precondition: undefined
        });
    }
    run(accessor, editor, args) {
