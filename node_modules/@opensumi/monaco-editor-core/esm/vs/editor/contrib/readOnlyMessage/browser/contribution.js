        ...
        if (messageController && this.editor.hasModel()) {
            ...
            if (!message) {
                if (this.editor.isSimpleWidget) {
                    message = new MarkdownString(nls.localize("vs/editor/contrib/readOnlyMessage/browser/contribution",0, "Cannot edit in read-only input"));
                }
                else {
                    message = new MarkdownString(nls.localize("vs/editor/contrib/readOnlyMessage/browser/contribution",1, "Cannot edit in read-only editor"));
                }
            }
