...
class InPlaceReplaceUp extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inPlaceReplace/browser/inPlaceReplace",0, "Replace with Previous Value"),
...
class InPlaceReplaceDown extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inPlaceReplace/browser/inPlaceReplace",1, "Replace with Next Value"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
