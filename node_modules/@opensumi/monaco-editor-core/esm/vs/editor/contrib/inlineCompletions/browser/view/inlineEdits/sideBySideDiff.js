...
import { autorun, constObservable, derived, derivedObservableWithCache, derivedOpts, observableFromEvent } from '../../../../../../base/common/observable.js';
...
export const originalBackgroundColor = registerColor('inlineEdit.originalBackground', Color.transparent, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",0, 'Background color for the original text in inline edits.'), true);
export const modifiedBackgroundColor = registerColor('inlineEdit.modifiedBackground', Color.transparent, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",1, 'Background color for the modified text in inline edits.'), true);
export const originalChangedLineBackgroundColor = registerColor('inlineEdit.originalChangedLineBackground', Color.transparent, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",2, 'Background color for the changed lines in the original text of inline edits.'), true);
export const originalChangedTextOverlayColor = registerColor('inlineEdit.originalChangedTextBackground', diffRemoved, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",3, 'Overlay color for the changed text in the original text of inline edits.'), true);
...
}, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",4, 'Background color for the changed lines in the modified text of inline edits.'), true);
export const modifiedChangedTextOverlayColor = registerColor('inlineEdit.modifiedChangedTextBackground', diffInserted, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",5, 'Overlay color for the changed text in the modified text of inline edits.'), true);
export const originalBorder = registerColor('inlineEdit.originalBorder', {
    light: editorHoverBorder,
    dark: editorHoverBorder,
    hcDark: editorHoverBorder,
    hcLight: editorHoverBorder
}, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",6, 'Border color for the original text in inline edits.'));
export const modifiedBorder = registerColor('inlineEdit.modifiedBorder', {
    light: editorHoverBorder,
    dark: editorHoverBorder,
    hcDark: editorHoverBorder,
    hcLight: editorHoverBorder
}, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/sideBySideDiff",7, 'Border color for the modified text in inline edits.'));
const PADDING = 4;
...
let InlineEditsSideBySideDiff = class InlineEditsSideBySideDiff extends Disposable {
    ...
    constructor(_editor, _edit, _previewTextModel, _uiState, _instantiationService, _commandService, _themeService) {
        ...
        this._editorContainer = n.div({
            class: ['editorContainer', this._editorObs.getOption(64 /* EditorOption.inlineSuggest */).map(v => !v.edits.useGutterIndicator && 'showHover')],
        ...
        this._foregroundSvg = n.svg({
            ...
            return [
                n.svgElem('path', {
                    ...
                    d: layoutInfoObs.map(layoutInfo => createRectangle({ topLeft: layoutInfo.codeStart1, width: layoutInfo.code1.x - layoutInfo.codeStart1.x, height: layoutInfo.code2.y - layoutInfo.code1.y }, 0, { topLeft: layoutInfo.borderRadius, bottomLeft: layoutInfo.borderRadius, topRight: 0, bottomRight: 0 }, { hideRight: true, hideLeft: layoutInfo.codeScrollLeft !== 0 })),
                    style: {
...
export { InlineEditsSideBySideDiff };
//# sourceMappingURL=sideBySideDiff.js.map