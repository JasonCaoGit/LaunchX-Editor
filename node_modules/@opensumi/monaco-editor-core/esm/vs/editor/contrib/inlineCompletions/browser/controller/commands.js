...
export class ShowNextInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",9, "Show Next Inline Suggestion"),
...
export class ShowPreviousInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",10, "Show Previous Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
                weight: 100,
...
export class TriggerInlineSuggestionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",11, "Trigger Inline Suggestion"),
...
export class ExplicitTriggerInlineEditAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",12, "Trigger Next Edit Suggestion"),
            precondition: EditorContextKeys.writable,
        });
    }
    async run(accessor, editor) {
        ...
        if (!controller?.model.get()?.inlineEditAvailable.get()) {
            notificationService.notify({
                ...
                message: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",0, "No inline edit is available.")
            });
        }
    }
}
...
export class AcceptNextWordOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",13, "Accept Next Word Of Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
            ...
            menuOpts: [{
                    ...
                    title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",1, 'Accept Word'),
                    group: 'primary',
                    order: 2,
                }],
        });
...
export class AcceptNextLineOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",14, "Accept Next Line Of Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
                weight: 100 /* KeybindingWeight.EditorContrib */ + 1,
            },
            menuOpts: [{
                    menuId: MenuId.InlineSuggestionToolbar,
                    title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",2, 'Accept Line'),
                    group: 'secondary',
                    order: 2,
                }],
        });
...
export class AcceptInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",15, "Accept Inline Suggestion"),
            ...
            menuOpts: [{
                    menuId: MenuId.InlineSuggestionToolbar,
                    title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",3, "Accept"),
                    group: 'primary',
                    order: 2,
                }, {
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",4, "Accept"),
                    group: 'primary',
                    order: 2,
                }],
            kbOpts: [
...
export class JumpToNextInlineEdit extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",16, "Jump to next inline edit"),
            precondition: InlineCompletionContextKeys.inlineEditVisible,
            menuOpts: [{
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",5, "Jump"),
                    group: 'primary',
                    order: 1,
...
export class HideInlineCompletion extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/inlineCompletions/browser/controller/commands",17, "Hide Inline Suggestion"),
            precondition: ContextKeyExpr.or(InlineCompletionContextKeys.inlineSuggestionVisible, InlineCompletionContextKeys.inlineEditVisible),
            kbOpts: {
            ...
            menuOpts: [{
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",6, "Reject"),
                    group: 'primary',
                    order: 3,
                }]
        });
...
export class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",7, "Always Show Toolbar"),
            f1: false,
...
export class DevExtractReproSample extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/inlineCompletions/browser/controller/commands",8, "Developer: Extract Inline Suggest State"),
