...
export declare class InlineCompletionItem {
    ...
    */
    ...
    constructor(filterText: string, command: Command | undefined, shownCommand: Command | undefined, range: Range, insertText: string, snippetInfo: SnippetInfo | undefined, cursorShowRange: Range | undefined, additionalTextEdits: readonly ISingleEditOperation[], 
    /**
     * A reference to the original inline completion this inline completion has been constructed from.
     * Used for event data to ensure referential equality.
    */
     ...
     * Used for event data to ensure referential equality.
    */
    source: InlineCompletionList, id?: string);
    get didShow(): boolean;
    markAsShown(): void;
