...
let InlineCompletionsHoverParticipant = class InlineCompletionsHoverParticipant {
    ...
    getAccessibleContent(hoverPart) {
        return nls.localize("vs/editor/contrib/inlineCompletions/browser/hintsWidget/hoverParticipant",0, 'There are inline completions here');
    }
    renderScreenReaderText(context, part) {
        ...
        const render = (code) => {
            const inlineSuggestionAvailable = nls.localize("vs/editor/contrib/inlineCompletions/browser/hintsWidget/hoverParticipant",1, "Suggestion:");
