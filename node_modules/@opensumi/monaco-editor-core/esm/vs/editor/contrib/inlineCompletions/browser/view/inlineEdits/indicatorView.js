...
import { constObservable, autorun } from '../../../../../../base/common/observable.js';
...
export const inlineEditIndicatorForeground = registerColor('inlineEdit.indicator.foreground', buttonForeground, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/indicatorView",0, 'Foreground color for the inline edit indicator.'));
export const inlineEditIndicatorBackground = registerColor('inlineEdit.indicator.background', buttonBackground, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/indicatorView",1, 'Background color for the inline edit indicator.'));
export const inlineEditIndicatorBorder = registerColor('inlineEdit.indicator.border', buttonSeparator, localize("vs/editor/contrib/inlineCompletions/browser/view/inlineEdits/indicatorView",2, 'Border color for the inline edit indicator.'));
