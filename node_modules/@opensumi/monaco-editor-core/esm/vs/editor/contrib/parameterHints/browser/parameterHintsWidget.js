...
const $ = dom.$;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, nls.localize("vs/editor/contrib/parameterHints/browser/parameterHintsWidget",0, 'Icon for show next parameter hint.'));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, nls.localize("vs/editor/contrib/parameterHints/browser/parameterHintsWidget",1, 'Icon for show previous parameter hint.'));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                aria.alert(nls.localize("vs/editor/contrib/parameterHints/browser/parameterHintsWidget",2, "{0}, hint", labelToAnnounce));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, nls.localize("vs/editor/contrib/parameterHints/browser/parameterHintsWidget",3, 'Foreground color of the active item in the parameter hint.'));
