 ...
 */
registerColor('editorSuggestWidget.background', editorWidgetBackground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",0, 'Background color of the suggest widget.'));
registerColor('editorSuggestWidget.border', editorWidgetBorder, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",1, 'Border color of the suggest widget.'));
const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",2, 'Foreground color of the suggest widget.'));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",3, 'Foreground color of the selected entry in the suggest widget.'));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",4, 'Icon foreground color of the selected entry in the suggest widget.'));
export const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",5, 'Background color of the selected entry in the suggest widget.'));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",6, 'Color of the match highlights in the suggest widget.'));
registerColor('editorSuggestWidget.focusHighlightForeground', listFocusHighlightForeground, nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",7, 'Color of the match highlights in the suggest widget when an item is focused.'));
registerColor('editorSuggestWidgetStatus.foreground', transparent(editorSuggestWidgetForeground, .5), nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",8, 'Foreground color of the suggest widget status.'));
var State;
(function (State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",9, "Loading..."); }
    static { this.NO_SUGGESTIONS_MESSAGE = nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",10, "No suggestions."); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                getRole: () => 'option',
                getWidgetAriaLabel: () => nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",11, "Suggest"),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",12, '{0} {1}, {2}', label, detail, description);
                        }
                        else if (detail) {
                            label = nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",13, '{0} {1}', label, detail);
                        }
                        else if (description) {
                            label = nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",14, '{0}, {1}', label, description);
                        }
                    }
                    ...
                    return nls.localize("vs/editor/contrib/suggest/browser/suggestWidget",15, "{0}, docs: {1}", label, docs);
                },
            }
        });
