...
let WordContextKey = class WordContextKey {
    ...
    static { this.AtEnd = new RawContextKey('atEndOfWord', false, { type: 'boolean', description: localize("vs/editor/contrib/suggest/browser/wordContextKey",0, "A context key that is true when at the end of a word. Note that this is only defined when tab-completions are enabled") }); }
