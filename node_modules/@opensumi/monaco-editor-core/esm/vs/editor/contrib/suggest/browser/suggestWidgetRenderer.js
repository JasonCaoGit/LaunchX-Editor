...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, nls.localize("vs/editor/contrib/suggest/browser/suggestWidgetRenderer",0, 'Icon for more information in the suggest widget.'));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = nls.localize("vs/editor/contrib/suggest/browser/suggestWidgetRenderer",1, "Read More");
        const configureFont = () => {
