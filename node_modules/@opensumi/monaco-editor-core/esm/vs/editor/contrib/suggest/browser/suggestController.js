...
let SuggestController = class SuggestController {
    ...
    _alertCompletionItem(item) {
        if (isNonEmptyArray(item.completion.additionalTextEdits)) {
            const msg = nls.localize("vs/editor/contrib/suggest/browser/suggestController",0, "Accepting '{0}' made {1} additional edits", item.textLabel, item.completion.additionalTextEdits.length);
            alert(msg);
        }
    }
...
export class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/suggest/browser/suggestController",8, "Trigger Suggest"),
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",1, "Insert"),
            group: 'left',
            order: 1,
            when: SuggestContext.HasInsertAndReplaceRange.toNegated()
        }, {
            menuId: suggestWidgetStatusbarMenu,
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",2, "Insert"),
            group: 'left',
            order: 1,
            when: ContextKeyExpr.and(SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('insert'))
        }, {
            menuId: suggestWidgetStatusbarMenu,
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",3, "Replace"),
            group: 'left',
            order: 1,
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            order: 2,
            when: ContextKeyExpr.and(SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('insert')),
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",4, "Replace")
        }, {
            menuId: suggestWidgetStatusbarMenu,
            group: 'left',
            order: 2,
            when: ContextKeyExpr.and(SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('replace')),
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",5, "Insert")
        }]
}));
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",6, "Show Less")
        }, {
            menuId: suggestWidgetStatusbarMenu,
            group: 'right',
            order: 1,
            when: ContextKeyExpr.and(SuggestContext.DetailsVisible.toNegated(), SuggestContext.CanResolve),
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",7, "Show More")
        }]
}));
registerEditorCommand(new SuggestCommand({
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/suggest/browser/suggestController",9, "Reset Suggest Widget Size"),
