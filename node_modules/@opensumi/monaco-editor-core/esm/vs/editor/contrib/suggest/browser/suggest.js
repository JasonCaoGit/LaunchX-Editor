...
export const Context = {
    ...
    HasFocusedSuggestion: new RawContextKey('suggestWidgetHasFocusedSuggestion', false, localize("vs/editor/contrib/suggest/browser/suggest",0, "Whether any suggestion is focused")),
    DetailsVisible: new RawContextKey('suggestWidgetDetailsVisible', false, localize("vs/editor/contrib/suggest/browser/suggest",1, "Whether suggestion details are visible")),
    MultipleSuggestions: new RawContextKey('suggestWidgetMultipleSuggestions', false, localize("vs/editor/contrib/suggest/browser/suggest",2, "Whether there are multiple suggestions to pick from")),
    MakesTextEdit: new RawContextKey('suggestionMakesTextEdit', true, localize("vs/editor/contrib/suggest/browser/suggest",3, "Whether inserting the current suggestion yields in a change or has everything already been typed")),
    AcceptSuggestionsOnEnter: new RawContextKey('acceptSuggestionOnEnter', true, localize("vs/editor/contrib/suggest/browser/suggest",4, "Whether suggestions are inserted when pressing Enter")),
    HasInsertAndReplaceRange: new RawContextKey('suggestionHasInsertAndReplaceRange', false, localize("vs/editor/contrib/suggest/browser/suggest",5, "Whether the current suggestion has insert and replace behaviour")),
    InsertMode: new RawContextKey('suggestionInsertMode', undefined, { type: 'string', description: localize("vs/editor/contrib/suggest/browser/suggest",6, "Whether the default behaviour is to insert or replace") }),
    CanResolve: new RawContextKey('suggestionCanResolve', false, localize("vs/editor/contrib/suggest/browser/suggest",7, "Whether the current suggestion supports to resolve further details")),
};
