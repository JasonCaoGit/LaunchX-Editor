...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? nls.localize("vs/editor/contrib/multicursor/browser/multicursor",0, "Cursor added: {0}", cursorPositions) : nls.localize("vs/editor/contrib/multicursor/browser/multicursor",1, "Cursors added: {0}", cursorPositions);
        status(msg);
    }
}
export class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",10, "Add Cursor Above"),
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",2, "&&Add Cursor Above"),
                order: 2
            }
        });
    }
...
export class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",11, "Add Cursor Below"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",3, "A&&dd Cursor Below"),
                order: 3
            }
        });
    }
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",12, "Add Cursors to Line Ends"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",4, "Add C&&ursors to Line Ends"),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",13, "Add Cursors To Bottom"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",14, "Add Cursors To Top"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
export class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",15, "Add Selection To Next Find Match"),
            precondition: undefined,
            kbOpts: {
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",5, "Add &&Next Occurrence"),
                order: 5
            }
        });
    }
...
export class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",16, "Add Selection To Previous Find Match"),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",6, "Add P&&revious Occurrence"),
                order: 6
            }
        });
    }
...
export class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",17, "Move Last Selection To Next Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",18, "Move Last Selection To Previous Find Match"),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
export class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",19, "Select All Occurrences of Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",7, "Select All &&Occurrences"),
                order: 7
            }
        });
    }
...
export class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",20, "Change All Occurrences"),
...
export class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",21, "Focus Next Cursor"),
            metadata: {
                description: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",8, "Focuses the next cursor"),
                args: [],
            },
            precondition: undefined
        });
...
export class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/multicursor/browser/multicursor",22, "Focus Previous Cursor"),
            metadata: {
                description: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",9, "Focuses the previous cursor"),
                args: [],
            },
            precondition: undefined
        });
