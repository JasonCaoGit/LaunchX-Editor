        ...
        if (this.editor.hasModel()) {
            ...
            this.editor.changeDecorations((accessor) => {
                ...
                this.decorationId = accessor.addDecoration(Selection.fromPositions(position, position), {
                    ...
                    hoverMessage: new MarkdownString().appendText(localize("vs/editor/contrib/anchorSelect/browser/anchorSelect",0, "Selection Anchor")),
                    className: 'selection-anchor'
                });
            });
            this.selectionAnchorSetContextKey.set(!!this.decorationId);
            alert(localize("vs/editor/contrib/anchorSelect/browser/anchorSelect",1, "Anchor set at {0}:{1}", position.lineNumber, position.column));
        }
    }
    goToSelectionAnchor() {
...
class SetSelectionAnchor extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2("vs/editor/contrib/anchorSelect/browser/anchorSelect",2, "Set Selection Anchor"),
...
class GoToSelectionAnchor extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2("vs/editor/contrib/anchorSelect/browser/anchorSelect",3, "Go to Selection Anchor"),
...
class SelectFromAnchorToCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2("vs/editor/contrib/anchorSelect/browser/anchorSelect",4, "Select from Anchor to Cursor"),
            precondition: SelectionAnchorSet,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class CancelSelectionAnchor extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2("vs/editor/contrib/anchorSelect/browser/anchorSelect",5, "Cancel Selection Anchor"),
            precondition: SelectionAnchorSet,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
