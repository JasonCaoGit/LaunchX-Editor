...
let SnippetController2 = class SnippetController2 {
    ...
    static { this.InSnippetMode = new RawContextKey('inSnippetMode', false, localize("vs/editor/contrib/snippet/browser/snippetController2",0, "Whether the editor in current in snippet mode")); }
    static { this.HasNextTabstop = new RawContextKey('hasNextTabstop', false, localize("vs/editor/contrib/snippet/browser/snippetController2",1, "Whether there is a next tab stop when in snippet mode")); }
    static { this.HasPrevTabstop = new RawContextKey('hasPrevTabstop', false, localize("vs/editor/contrib/snippet/browser/snippetController2",2, "Whether there is a previous tab stop when in snippet mode")); }
                ...
                provideCompletionItems: (model, position) => {
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: { id: 'jumpToNextSnippetPlaceholder', title: localize("vs/editor/contrib/snippet/browser/snippetController2",3, 'Go to next placeholder...') }
                        });
                    }
                    return { suggestions };
                }
