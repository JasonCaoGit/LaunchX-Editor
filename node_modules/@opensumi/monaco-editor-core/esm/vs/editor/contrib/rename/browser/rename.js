    ...
    async run() {
        ...
        try {
            ...
            if (e instanceof CancellationError) {
                ...
                if (typeof e === 'string' || isMarkdownString(e)) {
                    MessageController.get(this.editor)?.showMessage(e || nls.localize("vs/editor/contrib/rename/browser/rename",1, "An unknown error occurred while resolving rename location"), position);
                }
            }
            return undefined;
        }
        ...
        const renameOperation = raceCancellation(skeleton.provideRenameEdits(inputFieldResult.newName, cts2.token), cts2.token).then(async (renameResult) => {
            ...
            this._bulkEditService.apply(renameResult, {
                ...
                label: nls.localize("vs/editor/contrib/rename/browser/rename",2, "Renaming '{0}' to '{1}'", loc?.text, inputFieldResult.newName),
                code: 'undoredo.rename',
                quotableLabel: nls.localize("vs/editor/contrib/rename/browser/rename",3, "Renaming {0} to {1}", loc?.text, inputFieldResult.newName),
                respectAutoSaveConfig: true
            }).then(result => {
                trace('edits applied');
                if (result.ariaSummary) {
                    alert(nls.localize("vs/editor/contrib/rename/browser/rename",4, "Successfully renamed '{0}' to '{1}'. Summary: {2}", loc.text, inputFieldResult.newName, result.ariaSummary));
                }
            }).catch(err => {
...
export class RenameAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/rename/browser/rename",8, "Rename Symbol"),
...
Registry.as(Extensions.Configuration).registerConfiguration({
    ...
    properties: {
        'editor.rename.enablePreview': {
            ...
            description: nls.localize("vs/editor/contrib/rename/browser/rename",7, "Enable/disable the ability to preview changes before renaming"),
            default: true,
            type: 'boolean'
        }
    }
