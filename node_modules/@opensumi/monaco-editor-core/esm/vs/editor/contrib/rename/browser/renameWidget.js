...
/** for debugging */
const _sticky = false;
export const CONTEXT_RENAME_INPUT_VISIBLE = new RawContextKey('renameInputVisible', false, nls.localize("vs/editor/contrib/rename/browser/renameWidget",0, "Whether the rename input widget is visible"));
export const CONTEXT_RENAME_INPUT_FOCUSED = new RawContextKey('renameInputFocused', false, nls.localize("vs/editor/contrib/rename/browser/renameWidget",1, "Whether the rename input widget is focused"));
let RenameWidget = class RenameWidget {
    ...
    beforeRender() {
        ...
        this._label.innerText = nls.localize("vs/editor/contrib/rename/browser/renameWidget",2, "{0} to Rename, {1} to Preview", this._keybindingService.lookupKeybinding(accept)?.getLabel(), this._keybindingService.lookupKeybinding(preview)?.getLabel());
...
class RenameCandidateListView {
    ...
    setCandidates(candidates) {
        ...
        aria.status(nls.localize("vs/editor/contrib/rename/browser/renameWidget",3, "Received {0} rename suggestions", candidates.length));
    }
    clearCandidates() {
...
class InputWithButton {
    ...
    get domNode() {
        if (!this._domNode) {
            ...
            this._inputNode.setAttribute('aria-label', nls.localize("vs/editor/contrib/rename/browser/renameWidget",4, "Rename input. Type new name and press Enter to commit."));
            this._domNode.appendChild(this._inputNode);
            this._buttonNode = document.createElement('div');
            this._buttonNode.className = 'rename-suggestions-button';
            this._buttonNode.setAttribute('tabindex', '0');
            this._buttonGenHoverText = nls.localize("vs/editor/contrib/rename/browser/renameWidget",5, "Generate new name suggestions");
            this._buttonCancelHoverText = nls.localize("vs/editor/contrib/rename/browser/renameWidget",6, "Cancel");
