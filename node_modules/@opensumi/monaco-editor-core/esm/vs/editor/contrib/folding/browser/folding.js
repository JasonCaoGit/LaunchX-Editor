...
class UnfoldAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.unfold',
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",0, "Unfold"),
...
class UnFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",1, "Unfold Recursively"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.fold',
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",2, "Fold"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",3, "Toggle Fold"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",4, "Fold Recursively"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",5, "Toggle Fold Recursively"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllBlockCommentsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",6, "Fold All Block Comments"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllRegionsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",7, "Fold All Regions"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllRegionsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",8, "Unfold All Regions"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",9, "Fold All Except Selected"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",10, "Unfold All Except Selected"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.foldAll',
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",11, "Fold All"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.unfoldAll',
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",12, "Unfold All"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class GotoParentFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",13, "Go to Parent Fold"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: 100 /* KeybindingWeight.EditorContrib */
...
class GotoPreviousFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",14, "Go to Previous Folding Range"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: 100 /* KeybindingWeight.EditorContrib */
...
class GotoNextFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",15, "Go to Next Folding Range"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: 100 /* KeybindingWeight.EditorContrib */
...
class FoldRangeFromSelectionAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",16, "Create Folding Range from Selection"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveFoldRangeFromSelectionAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",17, "Remove Manual Folding Ranges"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleImportFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/folding/browser/folding",18, "Toggle Import Fold"),
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                weight: 100 /* KeybindingWeight.EditorContrib */
...
for (let i = 1; i <= 7; i++) {
    registerInstantiatedEditorAction(new FoldLevelAction({
        ...
        label: nls.localize2("vs/editor/contrib/folding/browser/folding",19, "Fold Level {0}", i),
        precondition: CONTEXT_FOLDING_ENABLED,
        kbOpts: {
            kbExpr: EditorContextKeys.editorTextFocus,
