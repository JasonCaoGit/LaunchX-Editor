...
export class NextMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2("vs/editor/contrib/gotoError/browser/gotoError",4, "Go to Next Problem (Error, Warning, Info)"); }
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, nls.localize("vs/editor/contrib/gotoError/browser/gotoError",0, 'Icon for goto next marker.')),
                group: 'navigation',
                order: 1
            }
        });
...
class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2("vs/editor/contrib/gotoError/browser/gotoError",5, "Go to Previous Problem (Error, Warning, Info)"); }
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, nls.localize("vs/editor/contrib/gotoError/browser/gotoError",1, 'Icon for goto previous marker.')),
                group: 'navigation',
                order: 2
            }
        });
...
class NextMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2("vs/editor/contrib/gotoError/browser/gotoError",6, "Go to Next Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                ...
                title: nls.localize("vs/editor/contrib/gotoError/browser/gotoError",2, "Next &&Problem"),
                group: '6_problem_nav',
                order: 1
            }
        });
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(false, true, {
            ...
            label: nls.localize2("vs/editor/contrib/gotoError/browser/gotoError",7, "Go to Previous Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarGoMenu,
                title: nls.localize("vs/editor/contrib/gotoError/browser/gotoError",3, "Previous &&Problem"),
                group: '6_problem_nav',
                order: 2
            }
        });
