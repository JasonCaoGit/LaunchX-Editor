...
export class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",4, "Convert Indentation to Spaces"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",5, "Convert the tab indentation to spaces."),
            }
        });
    }
    run(accessor, editor) {
...
export class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",6, "Convert Indentation to Tabs"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",7, "Convert the spaces indentation to tabs."),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? nls.localize("vs/editor/contrib/indentation/browser/indentation",0, "Configured Tab Size")
                : n === creationOpts.tabSize
                    ? nls.localize("vs/editor/contrib/indentation/browser/indentation",1, "Default Tab Size")
                    : n === modelOpts.tabSize
                        ? nls.localize("vs/editor/contrib/indentation/browser/indentation",2, "Current Tab Size")
                        : undefined)
        }));
        // auto focus the tabSize set for the current editor
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: nls.localize("vs/editor/contrib/indentation/browser/indentation",3, "Select Tab Size for Current File"), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
export class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",8, "Indent Using Tabs"),
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",9, "Use indentation with tabs."),
            }
        });
    }
}
export class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",10, "Indent Using Spaces"),
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",11, "Use indentation with spaces."),
            }
        });
    }
}
export class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",12, "Change Tab Display Size"),
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",13, "Change the space size equivalent of the tab."),
            }
        });
    }
}
export class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",14, "Detect Indentation from Content"),
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",15, "Detect the indentation from content."),
            }
        });
    }
    run(accessor, editor) {
...
export class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",16, "Reindent Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",17, "Reindent the lines of the editor."),
            }
        });
    }
    run(accessor, editor) {
...
export class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/indentation/browser/indentation",18, "Reindent Selected Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2("vs/editor/contrib/indentation/browser/indentation",19, "Reindent the selected lines of the editor."),
            }
        });
    }
    run(accessor, editor) {
