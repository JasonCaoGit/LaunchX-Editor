...
let MessageController = class MessageController {
    ...
    static { this.MESSAGE_VISIBLE = new RawContextKey('messageVisible', false, nls.localize("vs/editor/contrib/message/browser/messageController",0, 'Whether the editor is currently showing an inline message')); }
    static get(editor) {
