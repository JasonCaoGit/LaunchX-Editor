...
export class CloseButton extends Disposable {
    constructor(container) {
        ...
        const closeButton = dom.append(innerDiv, $('.button' + ThemeIcon.asCSSSelector(registerIcon('color-picker-close', Codicon.close, localize("vs/editor/contrib/colorPicker/browser/colorPickerParts/colorPickerCloseButton",0, 'Icon to close the color picker')))));
