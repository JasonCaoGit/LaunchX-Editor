...
MenuRegistry.appendMenuItem(MenuId.MenubarEditMenu, { submenu: MenuId.MenubarCopy, title: nls.localize2("vs/editor/contrib/clipboard/browser/clipboard",12, "Copy As"), group: '2_ccp', order: 3 });
MenuRegistry.appendMenuItem(MenuId.EditorContext, { submenu: MenuId.EditorContextCopy, title: nls.localize2("vs/editor/contrib/clipboard/browser/clipboard",13, "Copy As"), group: CLIPBOARD_CONTEXT_MENU_GROUP, order: 3 });
MenuRegistry.appendMenuItem(MenuId.EditorContext, { submenu: MenuId.EditorContextShare, title: nls.localize2("vs/editor/contrib/clipboard/browser/clipboard",14, "Share"), group: '11_share', order: -1, when: ContextKeyExpr.and(ContextKeyExpr.notEquals('resourceScheme', 'output'), EditorContextKeys.editorTextFocus) });
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, { submenu: MenuId.ExplorerContextShare, title: nls.localize2("vs/editor/contrib/clipboard/browser/clipboard",15, "Share"), group: '11_share', order: -1 });
...
class ExecCommandCopyWithSyntaxHighlightingAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/clipboard/browser/clipboard",16, "Copy With Syntax Highlighting"),
            precondition: undefined,
            kbOpts: {
...
function registerExecCommandImpl(target, browserCommand) {
    ...
    target.addImplementation(10000, 'code-editor', (accessor, args) => {
        ...
        if (focusedEditor && focusedEditor.hasTextFocus()) {
            ...
            if (focusedEditor.getOption(37 /* EditorOption.experimentalEditContextEnabled */) && browserCommand === 'cut') {
