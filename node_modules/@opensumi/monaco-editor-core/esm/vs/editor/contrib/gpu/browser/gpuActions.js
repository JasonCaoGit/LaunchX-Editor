...
class DebugEditorGpuRendererAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2("vs/editor/contrib/gpu/browser/gpuActions",3, "Developer: Debug Editor GPU Renderer"),
    ...
    async run(accessor, editor) {
        ...
        const choice = await quickInputService.pick([
            {
                label: localize("vs/editor/contrib/gpu/browser/gpuActions",0, "Log Texture Atlas Stats"),
                id: 'logTextureAtlasStats',
            },
            {
                label: localize("vs/editor/contrib/gpu/browser/gpuActions",1, "Save Texture Atlas"),
                id: 'saveTextureAtlas',
            },
            {
                label: localize("vs/editor/contrib/gpu/browser/gpuActions",2, "Draw Glyph"),
                id: 'drawGlyph',
            },
        ], { canPickMany: false });
        if (!choice) {
