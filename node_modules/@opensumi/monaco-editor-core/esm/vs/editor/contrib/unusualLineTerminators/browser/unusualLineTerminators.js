    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: nls.localize("vs/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators",0, "Unusual Line Terminators"),
                message: nls.localize("vs/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators",1, "Detected unusual line terminators"),
                detail: nls.localize("vs/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators",2, "The file '{0}' contains one or more unusual line terminator characters, like Line Separator (LS) or Paragraph Separator (PS).\n\nIt is recommended to remove them from the file. This can be configured via `editor.unusualLineTerminators`.", basename(model.uri)),
                primaryButton: nls.localize("vs/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators",3, "&&Remove Unusual Line Terminators"),
                cancelButton: nls.localize("vs/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators",4, "Ignore")
            });
        }
        finally {
            this._isPresentingDialog = false;
