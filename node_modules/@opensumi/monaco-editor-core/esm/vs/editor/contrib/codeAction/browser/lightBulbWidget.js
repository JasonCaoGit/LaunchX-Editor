...
const GUTTER_LIGHTBULB_ICON = registerIcon('gutter-lightbulb', Codicon.lightBulb, nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",0, 'Icon which spawns code actions menu from the gutter when there is no space in the editor.'));
const GUTTER_LIGHTBULB_AUTO_FIX_ICON = registerIcon('gutter-lightbulb-auto-fix', Codicon.lightbulbAutofix, nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",1, 'Icon which spawns code actions menu from the gutter when there is no space in the editor and a quick fix is available.'));
const GUTTER_LIGHTBULB_AIFIX_ICON = registerIcon('gutter-lightbulb-sparkle', Codicon.lightbulbSparkle, nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",2, 'Icon which spawns code actions menu from the gutter when there is no space in the editor and an AI fix is available.'));
const GUTTER_LIGHTBULB_AIFIX_AUTO_FIX_ICON = registerIcon('gutter-lightbulb-aifix-auto-fix', Codicon.lightbulbSparkleAutofix, nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",3, 'Icon which spawns code actions menu from the gutter when there is no space in the editor and an AI fix and a quick fix is available.'));
const GUTTER_SPARKLE_FILLED_ICON = registerIcon('gutter-lightbulb-sparkle-filled', Codicon.sparkleFilled, nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",4, 'Icon which spawns code actions menu from the gutter when there is no space in the editor and an AI fix and a quick fix is available.'));
var LightBulbState;
...
let LightBulbWidget = class LightBulbWidget extends Disposable {
    ...
    _updateLightbulbTitle(autoFix, autoRun) {
        ...
        if (autoRun) {
            this.title = nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",5, "Run: {0}", this.state.actions.validActions[0].action.title);
        }
        else if (autoFix && this._preferredKbLabel) {
            this.title = nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",6, "Show Code Actions. Preferred Quick Fix Available ({0})", this._preferredKbLabel);
        }
        else if (!autoFix && this._quickFixKbLabel) {
            this.title = nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",7, "Show Code Actions ({0})", this._quickFixKbLabel);
        }
        else if (!autoFix) {
            this.title = nls.localize("vs/editor/contrib/codeAction/browser/lightBulbWidget",8, "Show Code Actions");
        }
    }
    set title(value) {
