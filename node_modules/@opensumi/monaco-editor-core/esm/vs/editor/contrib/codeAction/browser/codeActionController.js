                ...
                if (action && action.action) {
                    ...
                    if (ranges && ranges.length > 0) {
                        ...
                        if (diagnostic.startLineNumber && diagnostic.startColumn) {
                            ...
                            aria.status(localize("vs/editor/contrib/codeAction/browser/codeActionController",0, "Context: {0} at line {1} and column {2}.", selectionText, diagnostic.startLineNumber, diagnostic.startColumn));
                        }
                    }
                }
                else {
    ...
    _getActionBarActions(actions, at, options) {
        ...
        if (options.includeDisabledActions && actions.validActions.length > 0 && actions.allActions.length !== actions.validActions.length) {
            resultActions.push(this._showDisabled ? {
                id: 'hideMoreActions',
                label: localize("vs/editor/contrib/codeAction/browser/codeActionController",1, 'Hide Disabled'),
                enabled: true,
                tooltip: '',
                class: undefined,
                run: () => {
                ...
                id: 'showMoreActions',
                label: localize("vs/editor/contrib/codeAction/browser/codeActionController",2, 'Show Disabled'),
                enabled: true,
                tooltip: '',
                class: undefined,
                run: () => {
