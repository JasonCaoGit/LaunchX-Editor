...
const overviewRulerBracketMatchForeground = registerColor('editorOverviewRuler.bracketMatchForeground', '#A0A0A0', nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",0, 'Overview ruler marker color for matching brackets.'));
class JumpToBracketAction extends EditorAction {
    constructor() {
        super({
            id: 'editor.action.jumpToBracket',
            label: nls.localize2("vs/editor/contrib/bracketMatching/browser/bracketMatching",2, "Go to Bracket"),
...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/bracketMatching/browser/bracketMatching",3, "Select to Bracket"),
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/bracketMatching/browser/bracketMatching",4, "Select the text inside and including the brackets or curly braces"),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
...
class RemoveBracketsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/bracketMatching/browser/bracketMatching",5, "Remove Brackets"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: 'editor.action.jumpToBracket',
        title: nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",1, "Go to &&Bracket")
    },
    order: 2
});
