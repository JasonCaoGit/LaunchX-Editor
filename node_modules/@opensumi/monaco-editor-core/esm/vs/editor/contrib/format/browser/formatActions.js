...
class FormatDocumentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/format/browser/formatActions",0, "Format Document"),
...
class FormatSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/format/browser/formatActions",1, "Format Selection"),
