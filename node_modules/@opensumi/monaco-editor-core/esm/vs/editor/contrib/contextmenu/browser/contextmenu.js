...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        const actions = [];
        actions.push(createAction({
            label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",0, "Minimap"),
        ...
        actions.push(createAction({
            label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",1, "Render Characters"),
        ...
        actions.push(createEnumAction(nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",2, "Vertical size"), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",3, "Proportional"),
                value: 'proportional'
            }, {
                label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",4, "Fill"),
                value: 'fill'
            }, {
                label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",5, "Fit"),
                value: 'fit'
            }]));
        actions.push(createEnumAction(nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",6, "Slider"), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",7, "Mouse Over"),
                value: 'mouseover'
            }, {
                label: nls.localize("vs/editor/contrib/contextmenu/browser/contextmenu",8, "Always"),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(132 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/contextmenu/browser/contextmenu",9, "Show Editor Context Menu"),
