...
let MarkerHoverParticipant = class MarkerHoverParticipant {
    ...
    renderMarkerStatusbar(context, markerHover, disposables) {
        if (markerHover.marker.severity === MarkerSeverity.Error || markerHover.marker.severity === MarkerSeverity.Warning || markerHover.marker.severity === MarkerSeverity.Info) {
            ...
            if (markerController) {
                context.statusBar.addAction({
                    label: nls.localize("vs/editor/contrib/hover/browser/markerHoverParticipant",0, "View Problem"),
        ...
        if (!this._editor.getOption(96 /* EditorOption.readOnly */)) {
            ...
            if (this.recentMarkerCodeActionsInfo) {
                if (IMarkerData.makeKey(this.recentMarkerCodeActionsInfo.marker) === IMarkerData.makeKey(markerHover.marker)) {
                    if (!this.recentMarkerCodeActionsInfo.hasCodeActions) {
                        quickfixPlaceholderElement.textContent = nls.localize("vs/editor/contrib/hover/browser/markerHoverParticipant",1, "No quick fixes available");
                    }
                }
                else {
                    this.recentMarkerCodeActionsInfo = undefined;
            ...
            const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo && !this.recentMarkerCodeActionsInfo.hasCodeActions ? Disposable.None : disposableTimeout(() => quickfixPlaceholderElement.textContent = nls.localize("vs/editor/contrib/hover/browser/markerHoverParticipant",2, "Checking for quick fixes..."), 200, disposables);
            ...
            codeActionsPromise.then(actions => {
                ...
                if (!this.recentMarkerCodeActionsInfo.hasCodeActions) {
                    actions.dispose();
                    quickfixPlaceholderElement.textContent = nls.localize("vs/editor/contrib/hover/browser/markerHoverParticipant",3, "No quick fixes available");
                    return;
                }
                ...
                context.statusBar.addAction({
                    label: nls.localize("vs/editor/contrib/hover/browser/markerHoverParticipant",4, "Quick Fix..."),
