...
export const INCREASE_HOVER_VERBOSITY_ACTION_LABEL = nls.localize("vs/editor/contrib/hover/browser/hoverActionIds",0, "Increase Hover Verbosity Level");
...
export const DECREASE_HOVER_VERBOSITY_ACTION_LABEL = nls.localize("vs/editor/contrib/hover/browser/hoverActionIds",1, "Decrease Hover Verbosity Level");
