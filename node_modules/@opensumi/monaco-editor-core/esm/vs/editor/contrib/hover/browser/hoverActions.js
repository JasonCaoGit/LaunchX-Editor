...
export class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",3, "Show or Focus Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",4, 'Show or focus the editor hover which shows documentation, references, and other content for a symbol at the current cursor position.'),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        nls.localize("vs/editor/contrib/hover/browser/hoverActions",0, 'The hover will not automatically take focus.'),
                                        nls.localize("vs/editor/contrib/hover/browser/hoverActions",1, 'The hover will take focus only if it is already visible.'),
                                        nls.localize("vs/editor/contrib/hover/browser/hoverActions",2, 'The hover will automatically take focus when it appears.'),
                                    ],
...
export class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",5, "Show Definition Preview Hover"),
            ...
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",6, 'Show the definition preview hover in the editor.'),
            },
        });
    }
    run(accessor, editor) {
...
export class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",7, "Hide Hover"),
...
export class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",8, "Scroll Up Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",9, 'Scroll up the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",10, "Scroll Down Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",11, 'Scroll down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",12, "Scroll Left Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",13, 'Scroll left the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",14, "Scroll Right Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",15, 'Scroll right the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",16, "Page Up Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",17, 'Page up the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",18, "Page Down Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",19, 'Page down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",20, "Go To Top Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",21, 'Go to the top of the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",22, "Go To Bottom Hover"),
            ...
            metadata: {
                description: nls.localize2("vs/editor/contrib/hover/browser/hoverActions",23, 'Go to the bottom of the editor hover.')
            },
        });
    }
    run(accessor, editor) {
