...
export class LinkedEditingAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linkedEditing/browser/linkedEditing",1, "Start Linked Editing"),
...
export const editorLinkedEditingBackground = registerColor('editor.linkedEditingBackground', { dark: Color.fromHex('#f00').transparent(0.3), light: Color.fromHex('#f00').transparent(0.3), hcDark: Color.fromHex('#f00').transparent(0.3), hcLight: Color.white }, nls.localize("vs/editor/contrib/linkedEditing/browser/linkedEditing",0, 'Background color when the editor auto renames on type.'));
