...
export const warningIcon = registerIcon('extensions-warning-message', Codicon.warning, nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",0, 'Icon shown with a warning message in the extensions editor.'));
        ...
        this._updateState = (state) => {
            if (state && state.hasMore) {
                ...
                if (state.nonBasicAsciiCharacterCount >= max) {
                    data = {
                        message: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",1, 'This document contains many non-basic ASCII unicode characters'),
                        command: new DisableHighlightingOfNonBasicAsciiCharactersAction(),
                    };
                }
                else if (state.ambiguousCharacterCount >= max) {
                    data = {
                        message: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",2, 'This document contains many ambiguous unicode characters'),
                        command: new DisableHighlightingOfAmbiguousCharactersAction(),
                    };
                }
                else if (state.invisibleCharacterCount >= max) {
                    data = {
                        message: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",3, 'This document contains many invisible unicode characters'),
...
const configureUnicodeHighlightOptionsStr = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",4, 'Configure Unicode Highlight Options');
let UnicodeHighlighterHoverParticipant = class UnicodeHighlighterHoverParticipant {
    ...
    computeSync(anchor, lineDecorations) {
        ...
        for (const d of lineDecorations) {
            ...
            switch (highlightInfo.reason.kind) {
                case 0 /* UnicodeHighlighterReasonKind.Ambiguous */: {
                    if (isBasicASCII(highlightInfo.reason.confusableWith)) {
                        reason = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",5, 'The character {0} could be confused with the ASCII character {1}, which is more common in source code.', codePointStr, formatCodePointMarkdown(highlightInfo.reason.confusableWith.codePointAt(0)));
                    }
                    else {
                        reason = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",6, 'The character {0} could be confused with the character {1}, which is more common in source code.', codePointStr, formatCodePointMarkdown(highlightInfo.reason.confusableWith.codePointAt(0)));
                    }
                    break;
                }
                case 1 /* UnicodeHighlighterReasonKind.Invisible */:
                    reason = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",7, 'The character {0} is invisible.', codePointStr);
                    break;
                case 2 /* UnicodeHighlighterReasonKind.NonBasicAscii */:
                    reason = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",8, 'The character {0} is not a basic ASCII character.', codePointStr);
                    break;
            }
            ...
            const adjustSettings = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",9, 'Adjust settings');
...
export class DisableHighlightingInCommentsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",18, "Disable highlighting of characters in comments"),
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",10, 'Disable Highlight In Comments');
    }
...
export class DisableHighlightingInStringsAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: nls.localize2("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",19, "Disable highlighting of characters in strings"),
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",11, 'Disable Highlight In Strings');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
export class DisableHighlightingOfAmbiguousCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: nls.localize2("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",20, "Disable highlighting of ambiguous characters"),
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",12, 'Disable Ambiguous Highlight');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
export class DisableHighlightingOfInvisibleCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",21, "Disable highlighting of invisible characters"),
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",13, 'Disable Invisible Highlight');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
export class DisableHighlightingOfNonBasicAsciiCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",22, "Disable highlighting of non basic ASCII characters"),
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",14, 'Disable Non ASCII Highlight');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
export class ShowExcludeOptions extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",23, "Show Exclude Options"),
            precondition: undefined
        });
    }
    async run(accessor, editor, args) {
        ...
        function getExcludeCharFromBeingHighlightedLabel(codePoint) {
            if (InvisibleCharacters.isInvisibleCharacter(codePoint)) {
                return nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",15, 'Exclude {0} (invisible character) from being highlighted', codePointToHex(codePoint));
            }
            return nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",16, 'Exclude {0} from being highlighted', `${codePointToHex(codePoint)} "${char}"`);
        }
        const options = [];
        if (reason.kind === 0 /* UnicodeHighlighterReasonKind.Ambiguous */) {
            for (const locale of reason.notAmbiguousInLocales) {
                options.push({
                    label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",17, "Allow unicode characters that are more common in the language \"{0}\".", locale),
                    run: async () => {
