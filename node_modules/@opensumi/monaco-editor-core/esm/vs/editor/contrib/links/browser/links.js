    ...
    openLinkOccurrence(occurrence, openToSide, fromUserGesture = false) {
        ...
        link.resolve(CancellationToken.None).then(uri => {
            ...
            if (messageOrError === 'invalid') {
                this.notificationService.warn(nls.localize("vs/editor/contrib/links/browser/links",0, 'Failed to open this link because it is not well-formed: {0}', link.url.toString()));
            }
            else if (messageOrError === 'missing') {
                this.notificationService.warn(nls.localize("vs/editor/contrib/links/browser/links",1, 'Failed to open this link because its target is missing.'));
            }
            else {
                onUnexpectedError(err);
            }
...
function getHoverMessage(link, useMetaKey) {
    ...
    const label = link.tooltip
        ? link.tooltip
        : executeCmd
            ? nls.localize("vs/editor/contrib/links/browser/links",2, 'Execute command')
            : nls.localize("vs/editor/contrib/links/browser/links",3, 'Follow link');
    const kb = useMetaKey
        ? platform.isMacintosh
            ? nls.localize("vs/editor/contrib/links/browser/links",4, "cmd + click")
            : nls.localize("vs/editor/contrib/links/browser/links",5, "ctrl + click")
        : platform.isMacintosh
            ? nls.localize("vs/editor/contrib/links/browser/links",6, "option + click")
            : nls.localize("vs/editor/contrib/links/browser/links",7, "alt + click");
    if (link.url) {
        let nativeLabel = '';
        if (/^command:/i.test(link.url.toString())) {
            ...
            if (match) {
                ...
                nativeLabel = nls.localize("vs/editor/contrib/links/browser/links",8, "Execute command {0}", commandId);
            }
        }
...
class OpenLinkAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/links/browser/links",9, "Open Link"),
