...
let PostEditWidgetManager = class PostEditWidgetManager extends Disposable {
    ...
    async applyEditAndShowIfNeeded(ranges, edits, canShowWidget, resolve, token) {
        ...
        try {
            ...
            return handleError(e, localize("vs/editor/contrib/dropOrPasteInto/browser/postEditWidget",0, "Error resolving edit '{0}':\n{1}", edit.title, toErrorMessage(e)));
        }
        ...
        try {
            ...
            return handleError(e, localize("vs/editor/contrib/dropOrPasteInto/browser/postEditWidget",1, "Error applying edit '{0}':\n{1}", edit.title, toErrorMessage(e)));
        }
        finally {
