...
registerEditorAction(class PasteAsAction extends EditorAction {
        ...
        oneOf: [
            ...
            },
            {
                ...
                properties: {
                    preferences: {
                        type: 'array',
                        description: nls.localize("vs/editor/contrib/dropOrPasteInto/browser/copyPasteContribution",1, "List of preferred paste edit kind to try applying.\nThe first edit matching the preferences will be applied."),
                        items: { type: 'string' }
                    }
                },
            }
    ...
    constructor() {
        super({
            id: pasteAsCommandId,
            label: nls.localize2("vs/editor/contrib/dropOrPasteInto/browser/copyPasteContribution",2, "Paste As..."),
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/dropOrPasteInto/browser/copyPasteContribution",3, "Paste as Text"),
            precondition: EditorContextKeys.writable,
        });
    }
