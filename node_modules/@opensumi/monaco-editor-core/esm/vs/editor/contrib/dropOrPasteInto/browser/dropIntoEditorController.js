...
export const dropWidgetVisibleCtx = new RawContextKey('dropWidgetVisible', false, localize("vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorController",0, "Whether the drop widget is showing"));
let DropIntoEditorController = class DropIntoEditorController extends Disposable {
    ...
    constructor(editor, instantiationService, _configService, _languageFeaturesService, _treeViewsDragAndDropService) {
        ...
        this._postDropWidgetManager = this._register(instantiationService.createInstance(PostEditWidgetManager, 'dropIntoEditor', editor, dropWidgetVisibleCtx, { id: changeDropTypeCommandId, label: localize("vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorController",1, "Show drop options...") }, () => DropIntoEditorController_1._configureDefaultAction ? [DropIntoEditorController_1._configureDefaultAction] : []));
    ...
    async onDropIntoEditor(editor, position, dragEvent) {
        ...
        this._dropProgressManager.showWhile(position, localize("vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorController",2, "Running drop handlers. Click to cancel"), p, { cancel: () => p.cancel() });
