...
export class DefaultTextPasteOrDropEditProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, _token) {
        ...
        return {
            ...
            title: localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",0, "Insert Plain Text"),
            insertText,
            kind: this.kind,
        };
    }
    ...
    async getEdit(dataTransfer, token) {
        ...
        if (uriCount > 0) {
            ...
            label = entries.length > 1
                ? localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",1, "Insert Uris")
                : localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",2, "Insert Uri");
        }
        else {
            // All the paths are file paths
            label = entries.length > 1
                ? localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",3, "Insert Paths")
                : localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",4, "Insert Path");
        }
        return {
    ...
    async getEdit(dataTransfer, token) {
        ...
        return {
            ...
            title: entries.length > 1
                ? localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",5, "Insert Relative Paths")
                : localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",6, "Insert Relative Path"),
            kind: this.kind,
        };
    }
};
    ...
    async provideDocumentPasteEdits(_model, _ranges, dataTransfer, context, token) {
        ...
        return {
            ...
            edits: [{
                    ...
                    title: localize("vs/editor/contrib/dropOrPasteInto/browser/defaultProviders",7, 'Insert HTML'),
                    kind: this.kind,
                }],
        };
    }
