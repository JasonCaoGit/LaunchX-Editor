...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",5, "Copy Line Up"),
            ...
            menuOpts: {
                ...
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",0, "&&Copy Line Up"),
                order: 1
            }
        });
    }
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",6, "Copy Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",1, "Co&&py Line Down"),
                order: 2
            }
        });
    }
...
export class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",7, "Duplicate Selection"),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",2, "&&Duplicate Selection"),
                order: 5
            }
        });
    }
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",8, "Move Line Up"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",3, "Mo&&ve Line Up"),
                order: 3
            }
        });
    }
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",9, "Move Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",4, "Move &&Line Down"),
                order: 4
            }
        });
    }
...
export class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",10, "Sort Lines Ascending"),
            precondition: EditorContextKeys.writable
        });
    }
}
export class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",11, "Sort Lines Descending"),
            precondition: EditorContextKeys.writable
        });
    }
}
export class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",12, "Delete Duplicate Lines"),
            precondition: EditorContextKeys.writable
        });
    }
    run(_accessor, editor) {
...
export class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",13, "Trim Trailing Whitespace"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",14, "Delete Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
export class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",15, "Indent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",16, "Outdent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineBeforeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",17, "Insert Line Above"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineAfterAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",18, "Insert Line Below"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",19, "Delete All Left"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
export class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",20, "Delete All Right"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
export class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",21, "Join Lines"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
...
export class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",22, "Transpose Characters around the Cursor"),
            precondition: EditorContextKeys.writable
        });
    }
    run(_accessor, editor) {
...
export class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",23, "Transform to Uppercase"),
            precondition: EditorContextKeys.writable
        });
    }
...
export class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",24, "Transform to Lowercase"),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
export class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",25, "Transform to Title Case"),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
export class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",26, "Transform to Snake Case"),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
export class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",27, "Transform to Camel Case"),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
export class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",28, "Transform to Pascal Case"),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
export class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/linesOperations/browser/linesOperations",29, 'Transform to Kebab Case'),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, _) {
