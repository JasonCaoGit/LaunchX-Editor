...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, nls.localize("vs/editor/contrib/find/browser/findWidget",0, 'Icon to indicate that the editor find widget is collapsed.'));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, nls.localize("vs/editor/contrib/find/browser/findWidget",1, 'Icon to indicate that the editor find widget is expanded.'));
export const findSelectionIcon = registerIcon('find-selection', Codicon.selection, nls.localize("vs/editor/contrib/find/browser/findWidget",2, 'Icon for \'Find in Selection\' in the editor find widget.'));
export const findReplaceIcon = registerIcon('find-replace', Codicon.replace, nls.localize("vs/editor/contrib/find/browser/findWidget",3, 'Icon for \'Replace\' in the editor find widget.'));
export const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, nls.localize("vs/editor/contrib/find/browser/findWidget",4, 'Icon for \'Replace All\' in the editor find widget.'));
export const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, nls.localize("vs/editor/contrib/find/browser/findWidget",5, 'Icon for \'Find Previous\' in the editor find widget.'));
export const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, nls.localize("vs/editor/contrib/find/browser/findWidget",6, 'Icon for \'Find Next\' in the editor find widget.'));
const NLS_FIND_DIALOG_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",7, "Find / Replace");
const NLS_FIND_INPUT_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",8, "Find");
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize("vs/editor/contrib/find/browser/findWidget",9, "Find");
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",10, "Previous Match");
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",11, "Next Match");
const NLS_TOGGLE_SELECTION_FIND_TITLE = nls.localize("vs/editor/contrib/find/browser/findWidget",12, "Find in Selection");
const NLS_CLOSE_BTN_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",13, "Close");
const NLS_REPLACE_INPUT_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",14, "Replace");
const NLS_REPLACE_INPUT_PLACEHOLDER = nls.localize("vs/editor/contrib/find/browser/findWidget",15, "Replace");
const NLS_REPLACE_BTN_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",16, "Replace");
const NLS_REPLACE_ALL_BTN_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",17, "Replace All");
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = nls.localize("vs/editor/contrib/find/browser/findWidget",18, "Toggle Replace");
const NLS_MATCHES_COUNT_LIMIT_TITLE = nls.localize("vs/editor/contrib/find/browser/findWidget",19, "Only the first {0} results are highlighted, but all find operations work on the entire text.", MATCHES_LIMIT);
export const NLS_MATCHES_LOCATION = nls.localize("vs/editor/contrib/find/browser/findWidget",20, "{0} of {1}");
export const NLS_NO_RESULTS = nls.localize("vs/editor/contrib/find/browser/findWidget",21, "No results");
...
export class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? nls.localize("vs/editor/contrib/find/browser/findWidget",22, "{0} found", label)
                : nls.localize("vs/editor/contrib/find/browser/findWidget",23, "{0} found for '{1}'", label, searchString);
        }
        if (currentMatch) {
            const ariaLabel = nls.localize("vs/editor/contrib/find/browser/findWidget",24, "{0} found for '{1}', at {2}", label, searchString, currentMatch.startLineNumber + ':' + currentMatch.startColumn);
        ...
        return nls.localize("vs/editor/contrib/find/browser/findWidget",25, "{0} found for '{1}'", label, searchString);
    }
    /**
        ...
        if (e.equals(ctrlKeyMod | 3 /* KeyCode.Enter */)) {
            if (this._keybindingService.dispatchEvent(e, e.target)) {
                ...
                if (platform.isWindows && platform.isNative && !this._ctrlEnterReplaceAllWarningPrompted) {
                    ...
                    this._notificationService.info(nls.localize("vs/editor/contrib/find/browser/findWidget",26, 'Ctrl+Enter now inserts line break instead of replacing all. You can modify the keybinding for editor.action.replaceAll to override this behavior.'));
