    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(nls.localize("vs/editor/contrib/find/browser/findController",0, "The file is too large to perform a replace all operation."));
                return false;
            }
...
export const StartFindAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2("vs/editor/contrib/find/browser/findController",7, "Find"),
    ...
    menuOpts: {
        ...
        group: '3_find',
        title: nls.localize("vs/editor/contrib/find/browser/findController",1, "&&Find"),
        order: 1
    }
}));
...
export class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",8, "Find With Arguments"),
...
export class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",9, "Find With Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: null,
                primary: 0,
...
export class NextMatchFindAction extends MatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",10, "Find Next"),
            precondition: undefined,
            kbOpts: [{
...
export class PreviousMatchFindAction extends MatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",11, "Find Previous"),
            precondition: undefined,
            kbOpts: [{
                    kbExpr: EditorContextKeys.focus,
...
export class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",12, "Go to Match..."),
    ...
    run(accessor, editor, args) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: nls.localize("vs/editor/contrib/find/browser/findController",2, "No matches. Try searching for something else.")
            });
            return;
        }
        ...
        inputBox.placeholder = nls.localize("vs/editor/contrib/find/browser/findController",3, "Type a number to go to a specific match (between 1 and {0})", matchesCount);
        ...
        const updatePickerAndEditor = (value) => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize("vs/editor/contrib/find/browser/findController",4, "Please type a number between 1 and {0}", controller.getState().matchesCount);
        ...
        disposables.add(inputBox.onDidAccept(() => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize("vs/editor/contrib/find/browser/findController",5, "Please type a number between 1 and {0}", controller.getState().matchesCount);
            }
        }));
...
export class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",13, "Find Next Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/find/browser/findController",14, "Find Previous Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export const StartFindReplaceAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2("vs/editor/contrib/find/browser/findController",15, "Replace"),
    precondition: ContextKeyExpr.or(EditorContextKeys.focus, ContextKeyExpr.has('editorIsOpen')),
    kbOpts: {
        kbExpr: null,
    ...
    menuOpts: {
        menuId: MenuId.MenubarEditMenu,
        group: '3_find',
        title: nls.localize("vs/editor/contrib/find/browser/findController",6, "&&Replace"),
        order: 2
    }
}));
