...
class ToggleCommentLineAction extends CommentLineAction {
    constructor() {
        super(0 /* Type.Toggle */, {
            ...
            label: nls.localize2("vs/editor/contrib/comment/browser/comment",2, "Toggle Line Comment"),
            ...
            menuOpts: {
                ...
                group: '5_insert',
                title: nls.localize("vs/editor/contrib/comment/browser/comment",0, "&&Toggle Line Comment"),
                order: 1
            }
        });
    }
...
class AddLineCommentAction extends CommentLineAction {
    constructor() {
        super(1 /* Type.ForceAdd */, {
            ...
            label: nls.localize2("vs/editor/contrib/comment/browser/comment",3, "Add Line Comment"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveLineCommentAction extends CommentLineAction {
    constructor() {
        super(2 /* Type.ForceRemove */, {
            ...
            label: nls.localize2("vs/editor/contrib/comment/browser/comment",4, "Remove Line Comment"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class BlockCommentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2("vs/editor/contrib/comment/browser/comment",5, "Toggle Block Comment"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarEditMenu,
                group: '5_insert',
                title: nls.localize("vs/editor/contrib/comment/browser/comment",1, "Toggle &&Block Comment"),
                order: 2
            }
        });
    }
