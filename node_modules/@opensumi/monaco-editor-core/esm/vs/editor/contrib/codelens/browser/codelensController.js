...
registerEditorAction(class ShowLensesInCurrentLine extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2("vs/editor/contrib/codelens/browser/codelensController",1, "Show CodeLens Commands For Current Line"),
        });
    }
    async run(accessor, editor) {
        ...
        const item = await quickInputService.pick(items, {
            canPickMany: false,
            placeHolder: localize("vs/editor/contrib/codelens/browser/codelensController",0, "Select a command")
        });
        if (!item) {
            // Nothing picked
            return;
