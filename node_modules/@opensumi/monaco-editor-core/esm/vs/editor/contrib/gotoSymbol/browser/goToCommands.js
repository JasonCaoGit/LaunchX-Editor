...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    ...
    title: nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",0, "Peek"),
    group: 'navigation',
    order: 100
});
...
export class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getDefinitionsAtPosition(languageFeaturesService.definitionProvider, model, position, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",1, 'Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",2, "No definition found for '{0}'", info.word)
            : nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",3, "No definition found");
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",27, "Go to Definition"),
                mnemonicTitle: nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",4, "Go to &&Definition"),
            },
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",28, "Open Definition to the Side"),
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",29, "Peek Definition"),
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getDeclarationsAtPosition(languageFeaturesService.declarationProvider, model, position, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",5, 'Declarations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",6, "No declaration found for '{0}'", info.word)
            : nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",7, "No declaration found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",30, "Go to Declaration"),
                mnemonicTitle: nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",8, "Go to &&Declaration"),
            },
    ...
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",9, "No declaration found for '{0}'", info.word)
            : nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",10, "No declaration found");
    }
});
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",31, "Peek Declaration"),
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getTypeDefinitionsAtPosition(languageFeaturesService.typeDefinitionProvider, model, position, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",11, 'Type Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",12, "No type definition found for '{0}'", info.word)
            : nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",13, "No type definition found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",32, "Go to Type Definition"),
                mnemonicTitle: nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",14, "Go to &&Type Definition"),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",33, "Peek Type Definition"),
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getImplementationsAtPosition(languageFeaturesService.implementationProvider, model, position, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",15, 'Implementations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",16, "No implementation found for '{0}'", info.word)
            : nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",17, "No implementation found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",34, "Go to Implementations"),
                mnemonicTitle: nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",18, "Go to &&Implementations"),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",35, "Peek Implementations"),
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",19, "No references found for '{0}'", info.word)
            : nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",20, "No references found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",36, "Go to References"),
                mnemonicTitle: nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",21, "Go to &&References"),
            },
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, true, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",22, 'References'));
    }
});
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",37, "Peek References"),
            precondition: ContextKeyExpr.and(EditorContextKeys.hasReferenceProvider, PeekContext.notInPeekEditor, EditorContextKeys.isInEmbeddedEditor.toNegated()),
            menu: {
                id: MenuId.EditorContextPeek,
                group: 'peek',
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, false, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",23, 'References'));
    }
});
//#endregion
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: nls.localize2("vs/editor/contrib/gotoSymbol/browser/goToCommands",38, "Go to Any Symbol"),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return new ReferencesModel(this._references, nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",24, 'Locations'));
    }
    _getNoResultFoundMessage(info) {
        return info && nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",25, "No results for '{0}'", info.word) || '';
    }
    _getGoToPreference(editor) {
