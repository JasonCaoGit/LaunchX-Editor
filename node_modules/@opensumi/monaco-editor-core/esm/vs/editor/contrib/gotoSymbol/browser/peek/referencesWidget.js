...
let ReferenceWidget = class ReferenceWidget extends peekView.PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = this._instantiationService.createInstance(TextModel, nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget",0, "no preview available"), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null);
        // tree
    ...
    _onNewModel() {
        ...
        if (this._model.isEmpty) {
            this.setTitle('');
            this._messageContainer.innerText = nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget",1, "No results");
    ...
    async _revealReference(reference, revealParent) {
        ...
        if (reference.uri.scheme !== Schemas.inMemory) {
            ...
            this.setTitle(nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget",2, "References"));
        }
