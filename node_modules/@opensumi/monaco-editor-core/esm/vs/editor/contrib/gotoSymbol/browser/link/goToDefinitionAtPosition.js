...
let GotoDefinitionAtPositionEditorContribution = class GotoDefinitionAtPositionEditorContribution {
    ...
    async startFindDefinition(position) {
        ...
        if (results.length > 1) {
            ...
            this.addDecoration(combinedRange, new MarkdownString().appendText(nls.localize("vs/editor/contrib/gotoSymbol/browser/link/goToDefinitionAtPosition",0, "Click to show {0} definitions.", results.length)));
        }
        else {
            // Single result
