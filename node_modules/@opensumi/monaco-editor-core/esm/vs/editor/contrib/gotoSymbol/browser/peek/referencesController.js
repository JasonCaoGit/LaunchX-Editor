...
export const ctxReferenceSearchVisible = new RawContextKey('referenceSearchVisible', false, nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesController",0, "Whether reference peek is visible, like 'Peek References' or 'Peek Definition'"));
let ReferencesController = class ReferencesController {
    ...
    toggleWidget(range, modelPromise, peekMode) {
        ...
        this._widget.setTitle(nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesController",1, "Loading..."));
            ...
            return this._widget.setModel(this._model).then(() => {
                if (this._widget && this._model && this._editor.hasModel()) { // might have been closed
                    ...
                    if (!this._model.isEmpty) {
                        this._widget.setMetaTitle(nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesController",2, "{0} ({1})", this._model.title, this._model.references.length));
                    }
                    else {
