...
let FileReferencesTemplate = class FileReferencesTemplate extends Disposable {
    ...
    set(element, matches) {
        ...
        if (len > 1) {
            this.badge.setTitleFormat(localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesTree",0, "{0} references", len));
        }
        else {
            this.badge.setTitleFormat(localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesTree",1, "{0} reference", len));
        }
    }
};
...
export class AccessibilityProvider {
    getWidgetAriaLabel() {
        return localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesTree",2, "References");
    }
