    ...
    _expectAnotherChord(firstChord, keypressLabel) {
        ...
        switch (this._currentChords.length) {
            ...
            case 1:
                ...
                this._currentChordStatusMessage = this._notificationService.status(nls.localize("vs/platform/keybinding/common/abstractKeybindingService",0, "({0}) was pressed. Waiting for second key of chord...", keypressLabel));
                break;
            default: {
                const fullKeypressLabel = this._currentChords.map(({ label }) => label).join(', ');
                this._currentChordStatusMessage = this._notificationService.status(nls.localize("vs/platform/keybinding/common/abstractKeybindingService",1, "({0}) was pressed. Waiting for next key of chord...", fullKeypressLabel));
            }
        }
        ...
        switch (resolveResult.kind) {
            case 0 /* ResultKind.NoMatchingKb */: {
                ...
                if (this.inChordMode) {
                    ...
                    this._notificationService.status(nls.localize("vs/platform/keybinding/common/abstractKeybindingService",2, "The key combination ({0}, {1}) is not a command.", currentChordsLabel, keypressLabel), { hideAfter: 10 * 1000 /* 10s */ });
                    this._leaveChordMode();
            ...
            case 2 /* ResultKind.KbFound */: {
                ...
                if (resolveResult.commandId === null || resolveResult.commandId === '') {
                    if (this.inChordMode) {
                        ...
                        this._notificationService.status(nls.localize("vs/platform/keybinding/common/abstractKeybindingService",3, "The key combination ({0}, {1}) is not a command.", currentChordsLabel, keypressLabel), { hideAfter: 10 * 1000 /* 10s */ });
                        this._leaveChordMode();
                        shouldPreventDefault = true;
                    }
                }
