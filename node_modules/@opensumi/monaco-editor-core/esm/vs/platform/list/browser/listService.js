...
configurationRegistry.registerConfiguration({
    id: 'workbench',
    order: 7,
    title: localize("vs/platform/list/browser/listService",0, "Workbench"),
    type: 'object',
    properties: {
        [multiSelectModifierSettingKey]: {
            ...
            markdownEnumDescriptions: [
                localize("vs/platform/list/browser/listService",1, "Maps to `Control` on Windows and Linux and to `Command` on macOS."),
                localize("vs/platform/list/browser/listService",2, "Maps to `Alt` on Windows and Linux and to `Option` on macOS.")
            ],
            default: 'ctrlCmd',
            description: localize("vs/platform/list/browser/listService",3, "The modifier to be used to add an item in trees and lists to a multi-selection with the mouse (for example in the explorer, open editors and scm view). The 'Open to Side' mouse gestures - if supported - will adapt such that they do not conflict with the multiselect modifier.")
        ...
        [openModeSettingKey]: {
            ...
            default: 'singleClick',
            description: localize("vs/platform/list/browser/listService",4, "Controls how to open items in trees and lists using the mouse (if supported). Note that some trees and lists might choose to ignore this setting if it is not applicable.")
        ...
        [horizontalScrollingKey]: {
            type: 'boolean',
            default: false,
            description: localize("vs/platform/list/browser/listService",5, "Controls whether lists and trees support horizontal scrolling in the workbench. Warning: turning on this setting has a performance implication.")
        },
        [scrollByPageKey]: {
            type: 'boolean',
            default: false,
            description: localize("vs/platform/list/browser/listService",6, "Controls whether clicks in the scrollbar scroll page by page.")
        },
        [treeIndentKey]: {
            type: 'number',
            default: 8,
            minimum: 4,
            maximum: 40,
            description: localize("vs/platform/list/browser/listService",7, "Controls tree indentation in pixels.")
        },
        [treeRenderIndentGuidesKey]: {
            type: 'string',
            enum: ['none', 'onHover', 'always'],
            default: 'onHover',
            description: localize("vs/platform/list/browser/listService",8, "Controls whether the tree should render indent guides.")
        },
        [listSmoothScrolling]: {
            type: 'boolean',
            default: false,
            description: localize("vs/platform/list/browser/listService",9, "Controls whether lists and trees have smooth scrolling."),
        },
        [mouseWheelScrollSensitivityKey]: {
            type: 'number',
            default: 1,
            markdownDescription: localize("vs/platform/list/browser/listService",10, "A multiplier to be used on the `deltaX` and `deltaY` of mouse wheel scroll events.")
        },
        [fastScrollSensitivityKey]: {
            type: 'number',
            default: 5,
            markdownDescription: localize("vs/platform/list/browser/listService",11, "Scrolling speed multiplier when pressing `Alt`.")
        },
        [defaultFindModeSettingKey]: {
            type: 'string',
            enum: ['highlight', 'filter'],
            enumDescriptions: [
                localize("vs/platform/list/browser/listService",12, "Highlight elements when searching. Further up and down navigation will traverse only the highlighted elements."),
                localize("vs/platform/list/browser/listService",13, "Filter elements when searching.")
            ],
            default: 'highlight',
            description: localize("vs/platform/list/browser/listService",14, "Controls the default find mode for lists and trees in the workbench.")
        },
        [keyboardNavigationSettingKey]: {
            type: 'string',
            enum: ['simple', 'highlight', 'filter'],
            enumDescriptions: [
                localize("vs/platform/list/browser/listService",15, "Simple keyboard navigation focuses elements which match the keyboard input. Matching is done only on prefixes."),
                localize("vs/platform/list/browser/listService",16, "Highlight keyboard navigation highlights elements which match the keyboard input. Further up and down navigation will traverse only the highlighted elements."),
                localize("vs/platform/list/browser/listService",17, "Filter keyboard navigation will filter out and hide all the elements which do not match the keyboard input.")
            ],
            default: 'highlight',
            description: localize("vs/platform/list/browser/listService",18, "Controls the keyboard navigation style for lists and trees in the workbench. Can be simple, highlight and filter."),
            deprecated: true,
            deprecationMessage: localize("vs/platform/list/browser/listService",19, "Please use 'workbench.list.defaultFindMode' and	'workbench.list.typeNavigationMode' instead.")
        },
        [defaultFindMatchTypeSettingKey]: {
            type: 'string',
            enum: ['fuzzy', 'contiguous'],
            enumDescriptions: [
                localize("vs/platform/list/browser/listService",20, "Use fuzzy matching when searching."),
                localize("vs/platform/list/browser/listService",21, "Use contiguous matching when searching.")
            ],
            default: 'fuzzy',
            description: localize("vs/platform/list/browser/listService",22, "Controls the type of matching used when searching lists and trees in the workbench.")
        },
        [treeExpandMode]: {
            type: 'string',
            enum: ['singleClick', 'doubleClick'],
            default: 'singleClick',
            description: localize("vs/platform/list/browser/listService",23, "Controls how tree folders are expanded when clicking the folder names. Note that some trees and lists might choose to ignore this setting if it is not applicable."),
        },
        [treeStickyScroll]: {
            type: 'boolean',
            default: true,
            description: localize("vs/platform/list/browser/listService",24, "Controls whether sticky scrolling is enabled in trees."),
        },
        [treeStickyScrollMaxElements]: {
            type: 'number',
            minimum: 1,
            default: 7,
            markdownDescription: localize("vs/platform/list/browser/listService",25, "Controls the number of sticky elements displayed in the tree when {0} is enabled.", '`#workbench.tree.enableStickyScroll#`'),
        },
        [typeNavigationModeSettingKey]: {
            type: 'string',
            enum: ['automatic', 'trigger'],
            default: 'automatic',
            markdownDescription: localize("vs/platform/list/browser/listService",26, "Controls how type navigation works in lists and trees in the workbench. When set to `trigger`, type navigation begins once the `list.triggerTypeNavigation` command is run."),
        }
    }
});
