    ...
    renderElement(element, _index, data) {
        ...
        if (element.disabled) {
            ...
            if (this._supportsPreview && element.canPreview) {
                data.container.title = localize("vs/platform/actionWidget/browser/actionList",0, "{0} to Apply, {1} to Preview", actionTitle, previewTitle);
            }
            else {
                data.container.title = localize("vs/platform/actionWidget/browser/actionList",1, "{0} to Apply", actionTitle);
            }
        }
        else {
            ...
            accessibilityProvider: {
                getAriaLabel: element => {
                    if (element.kind === "action" /* ActionListItemKind.Action */) {
                        ...
                        if (element.disabled) {
                            label = localize("vs/platform/actionWidget/browser/actionList",2, "{0}, Disabled Reason: {1}", label, element.disabled);
                        }
                        return label;
                    }
                    return null;
                },
                getWidgetAriaLabel: () => localize("vs/platform/actionWidget/browser/actionList",3, "Action Widget"),
