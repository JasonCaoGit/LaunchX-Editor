...
function hintDidYouMean(...meant) {
    switch (meant.length) {
        case 1:
            return localize("vs/platform/contextkey/common/scanner",0, "Did you mean {0}?", meant[0]);
        case 2:
            return localize("vs/platform/contextkey/common/scanner",1, "Did you mean {0} or {1}?", meant[0], meant[1]);
        case 3:
            return localize("vs/platform/contextkey/common/scanner",2, "Did you mean {0}, {1} or {2}?", meant[0], meant[1], meant[2]);
        default: // we just don't expect that many
            return undefined;
    }
}
const hintDidYouForgetToOpenOrCloseQuote = localize("vs/platform/contextkey/common/scanner",3, "Did you forget to open or close the quote?");
const hintDidYouForgetToEscapeSlash = localize("vs/platform/contextkey/common/scanner",4, "Did you forget to escape the '/' (slash) character? Put two backslashes before it to escape, e.g., '\\\\/\'.");
/**
