...
const errorEmptyString = localize("vs/platform/contextkey/common/contextkey",0, "Empty context key expression");
const hintEmptyString = localize("vs/platform/contextkey/common/contextkey",1, "Did you forget to write an expression? You can also put 'false' or 'true' to always evaluate to false or true, respectively.");
const errorNoInAfterNot = localize("vs/platform/contextkey/common/contextkey",2, "'in' after 'not'.");
const errorClosingParenthesis = localize("vs/platform/contextkey/common/contextkey",3, "closing parenthesis ')'");
const errorUnexpectedToken = localize("vs/platform/contextkey/common/contextkey",4, "Unexpected token");
const hintUnexpectedToken = localize("vs/platform/contextkey/common/contextkey",5, "Did you forget to put && or || before the token?");
const errorUnexpectedEOF = localize("vs/platform/contextkey/common/contextkey",6, "Unexpected end of expression");
const hintUnexpectedEOF = localize("vs/platform/contextkey/common/contextkey",7, "Did you forget to put a context key?");
/**
...
export class Parser {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = localize("vs/platform/contextkey/common/contextkey",8, "Expected: {0}\nReceived: '{1}'.", expected, Scanner.getLexeme(got));
