...
export const fontIdErrorMessage = localize("vs/platform/theme/common/iconRegistry",0, 'The font ID must only contain letters, numbers, underscores and dashes.');
class IconRegistry {
    constructor() {
        ...
        this.iconSchema = {
            definitions: {
                icons: {
                    type: 'object',
                    properties: {
                        fontId: { type: 'string', description: localize("vs/platform/theme/common/iconRegistry",1, 'The id of the font to use. If not set, the font that is defined first is used.'), pattern: fontIdRegex.source, patternErrorMessage: fontIdErrorMessage },
                        fontCharacter: { type: 'string', description: localize("vs/platform/theme/common/iconRegistry",2, 'The font character associated with the icon definition.') }
                    },
...
// common icons
export const widgetClose = registerIcon('widget-close', Codicon.close, localize("vs/platform/theme/common/iconRegistry",3, 'Icon for the close action in widgets.'));
export const gotoPreviousLocation = registerIcon('goto-previous-location', Codicon.arrowUp, localize("vs/platform/theme/common/iconRegistry",4, 'Icon for goto previous editor location.'));
export const gotoNextLocation = registerIcon('goto-next-location', Codicon.arrowDown, localize("vs/platform/theme/common/iconRegistry",5, 'Icon for goto next editor location.'));
