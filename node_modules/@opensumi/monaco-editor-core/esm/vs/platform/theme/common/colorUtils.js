...
class ColorRegistry {
    ...
    registerColor(id, defaults, description, needsTransparency = false, deprecationMessage) {
        ...
        if (needsTransparency) {
            ...
            propertySchema.patternErrorMessage = nls.localize("vs/platform/theme/common/colorUtils",0, 'This color must be transparent or it will obscure content');
        }
        this.colorSchema.properties[id] = {
            description,
            oneOf: [
                propertySchema,
                { type: 'string', const: DEFAULT_COLOR_CONFIG_VALUE, description: nls.localize("vs/platform/theme/common/colorUtils",1, 'Use the default color.') }
            ]
        };
