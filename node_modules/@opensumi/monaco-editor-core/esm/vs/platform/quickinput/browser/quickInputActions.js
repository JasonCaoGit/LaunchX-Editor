...
const defaultCommandAndKeybindingRule = {
    ...
    metadata: { description: localize("vs/platform/quickinput/browser/quickInputActions",0, "Used while in the context of the quick pick. If you change one keybinding for this command, you should change all of the other keybindings (modifier variants) of this command as well.") }
};
...
const nextSeparatorFallbackDesc = localize("vs/platform/quickinput/browser/quickInputActions",1, "If we're in quick access mode, this will navigate to the next item. If we are not in quick access mode, this will navigate to the next separator.");
const prevSeparatorFallbackDesc = localize("vs/platform/quickinput/browser/quickInputActions",2, "If we're in quick access mode, this will navigate to the previous item. If we are not in quick access mode, this will navigate to the previous separator.");
if (isMacintosh) {
