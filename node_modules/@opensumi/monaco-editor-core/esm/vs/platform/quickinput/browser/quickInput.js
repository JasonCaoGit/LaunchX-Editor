...
export const InQuickInputContextKey = new RawContextKey(inQuickInputContextKeyValue, false, localize("vs/platform/quickinput/browser/quickInput",0, "Whether keyboard focus is inside the quick input control"));
...
export const QuickInputAlignmentContextKey = new RawContextKey(quickInputAlignmentContextKeyValue, 'top', localize("vs/platform/quickinput/browser/quickInput",1, "The alignment of the quick input"));
export const quickInputTypeContextKeyValue = 'quickInputType';
export const QuickInputTypeContextKey = new RawContextKey(quickInputTypeContextKeyValue, undefined, localize("vs/platform/quickinput/browser/quickInput",2, "The type of the currently visible quick input"));
export const endOfQuickInputBoxContextKeyValue = 'cursorAtEndOfQuickInputBox';
export const EndOfQuickInputBoxContextKey = new RawContextKey(endOfQuickInputBoxContextKeyValue, false, localize("vs/platform/quickinput/browser/quickInput",3, "Whether the cursor in the quick input is at the end of the input box"));
export const endOfQuickInputBoxContext = ContextKeyExpr.has(endOfQuickInputBoxContextKeyValue);
export const backButton = {
    iconClass: ThemeIcon.asClassName(Codicon.quickInputBack),
    tooltip: localize("vs/platform/quickinput/browser/quickInput",4, "Back"),
    handle: -1 // TODO
};
class QuickInput extends Disposable {
    static { this.noPromptMessage = localize("vs/platform/quickinput/browser/quickInput",5, "Press 'Enter' to confirm your input or 'Escape' to cancel"); }
    constructor(ui) {
        super();
        this.ui = ui;
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return localize("vs/platform/quickinput/browser/quickInput",6, "{0}/{1}", this.step, this.totalSteps);
        }
        if (this.step) {
...
export class QuickPick extends QuickInput {
    ...
    static { this.DEFAULT_ARIA_LABEL = localize("vs/platform/quickinput/browser/quickInput",7, "Type to narrow down results."); }
    get quickNavigate() {
    ...
    get okLabel() {
        return this._okLabel ?? localize("vs/platform/quickinput/browser/quickInput",8, "OK");
    }
    set okLabel(okLabel) {
...
export class InputBox extends QuickInput {
    ...
    set prompt(prompt) {
        ...
        this.noValidationMessage = prompt
            ? localize("vs/platform/quickinput/browser/quickInput",9, "{0} (Press 'Enter' to confirm or 'Escape' to cancel)", prompt)
