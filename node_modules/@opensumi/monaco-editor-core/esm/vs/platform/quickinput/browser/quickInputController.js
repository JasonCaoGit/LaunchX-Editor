...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        checkAll.setAttribute('aria-label', localize("vs/platform/quickinput/browser/quickInputController",0, "Toggle all checkboxes"));
        ...
        const visibleCount = this._register(new CountBadge(visibleCountContainer, { countFormat: localize("vs/platform/quickinput/browser/quickInputController",1, "{0} Results") }, this.styles.countBadge));
        const countContainer = dom.append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = this._register(new CountBadge(countContainer, { countFormat: localize("vs/platform/quickinput/browser/quickInputController",2, "{0} Selected") }, this.styles.countBadge));
        ...
        ok.label = localize("vs/platform/quickinput/browser/quickInputController",3, "OK");
        this._register(ok.onDidClick(e => {
            this.onDidAcceptEmitter.fire();
        }));
        const customButtonContainer = dom.append(headerContainer, $('.quick-input-action'));
        const customButton = this._register(new Button(customButtonContainer, { ...this.styles.button, supportIcons: true }));
        customButton.label = localize("vs/platform/quickinput/browser/quickInputController",4, "Custom");
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? localize("vs/platform/quickinput/browser/quickInputController",5, "Back ({0})", backKeybindingLabel) : localize("vs/platform/quickinput/browser/quickInputController",6, "Back");
