...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    ...
    getTooltip() {
        ...
        let title = keybindingLabel
            ? localize("vs/platform/actions/browser/menuEntryActionViewItem",0, "{0} ({1})", tooltip, keybindingLabel)
            : tooltip;
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            ...
            const altTitleSection = altKeybindingLabel
                ? localize("vs/platform/actions/browser/menuEntryActionViewItem",1, "{0} ({1})", altTooltip, altKeybindingLabel)
                : altTooltip;
            title = localize("vs/platform/actions/browser/menuEntryActionViewItem",2, "{0}\n[{1}] {2}", title, UILabelProvider.modifierLabels[OS].altKey, altTitleSection);
        }
        return title;
    }
    updateClass() {
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = localize("vs/platform/actions/browser/menuEntryActionViewItem",3, '{1} to {0}', this._action.label, kb2);
            }
            else {
                this.label.textContent = localize("vs/platform/actions/browser/menuEntryActionViewItem",4, '{0} ({1})', this._action.label, kb2);
            }
        }
    }
