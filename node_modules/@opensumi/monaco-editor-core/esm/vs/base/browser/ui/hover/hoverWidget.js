...
export function getHoverAccessibleViewHint(shouldHaveHint, keybinding) {
    return shouldHaveHint && keybinding ? localize("vs/base/browser/ui/hover/hoverWidget",0, "Inspect this in the accessible view with {0}.", keybinding) : shouldHaveHint ? localize("vs/base/browser/ui/hover/hoverWidget",1, "Inspect this in the accessible view via the command Open Accessible View which is currently not triggerable via keybinding.") : '';
}
