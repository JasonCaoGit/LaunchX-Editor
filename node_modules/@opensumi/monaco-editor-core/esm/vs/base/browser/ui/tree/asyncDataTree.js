...
class AsyncFindController extends FindController {
    ...
    onDidToggleChange(e) {
        ...
        this.placeholder = this.mode === TreeFindMode.Filter ? localize("vs/base/browser/ui/tree/asyncDataTree",0, "Type to filter") : localize("vs/base/browser/ui/tree/asyncDataTree",1, "Type to search");
